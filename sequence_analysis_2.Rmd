...
```{r}
survey_data_t2_t3 <- read.csv2("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/CKV analysis - sequence - survey/group_survey_data_t2_t3", stringsAsFactors = F)
...
```{r}
gini_data_t2_t3 <- read.csv2("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/CKV analysis - sequence - survey/gini_t2_t3", stringsAsFactors = F)
...
wordcounts_by_cluster[wordcounts_by_cluster$membership_manual==1,]$Ko_count <- conditional_membership[conditional_membership$membership_manual == 1 & conditional_membership$condition == "Ko",]$n
wordcounts_by_cluster[wordcounts_by_cluster$membership_manual==1,]$M_count <- conditional_membership[conditional_membership$membership_manual == 1 & conditional_membership$condition == "M",]$n
wordcounts_by_cluster[wordcounts_by_cluster$membership_manual==1,]$MG_count <- conditional_membership[conditional_membership$membership_manual == 1 & conditional_membership$condition == "MG",]$n

wordcounts_by_cluster[wordcounts_by_cluster$membership_manual==2,]$Ko_count <- conditional_membership[conditional_membership$membership_manual == 2 & conditional_membership$condition == "Ko",]$n
wordcounts_by_cluster[wordcounts_by_cluster$membership_manual==2,]$M_count <- conditional_membership[conditional_membership$membership_manual == 2 & conditional_membership$condition == "M",]$n
wordcounts_by_cluster[wordcounts_by_cluster$membership_manual==2,]$MG_count <- conditional_membership[conditional_membership$membership_manual == 2 & conditional_membership$condition == "MG",]$n
