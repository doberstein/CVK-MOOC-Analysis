...
```{r}
survey_data_t2_t3 <- read.csv2("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/survey - sequence - analysis/group_survey_data_t2_t3", stringsAsFactors = F)
...
wordcounts_by_cluster <- wordcounts_memberships %>% 
  ...
  dplyr::summarise(average_wordcount = mean(wordcount), sd_wordcount = sd(wordcount),
            ...
            average_zufried09 = mean(Zufried_09), sd_zufried09 = sd(Zufried_09),
            average_zufried10 = mean(Zufried_10), sd_zufried10 = sd(Zufried_10)
            )
