...
```{r}
gini_data <- read.csv2("/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/analysis/task3_work_imbalances.csv", stringsAsFactors = F) %>% 
  filter(!group_id == 543) # filter inactive group
