...
wiki_seq_day1 <- sequences %>% 
  filter(period <= 1 & type == "wiki") 
wiki_seq_day2 <- sequences %>% 
  filter(period <= 2 & type == "wiki")
wiki_seq_day3 <- sequences %>% 
  filter(period <= 3 & type == "wiki")
wiki_seq_day4 <- sequences %>% 
  filter(period <= 4 & type == "wiki")
wiki_seq_day5 <- sequences %>% 
  filter(period <= 5 & type == "wiki")
wiki_seq_day6 <- sequences %>% 
  filter(period <= 6 & type == "wiki")
wiki_seq_day7 <- sequences %>% 
  filter(period <= 7 & type == "wiki")
wiki_seq_day8 <- sequences %>% 
  filter(period <= 8 & type == "wiki")
wiki_seq_day9 <- sequences %>% 
  filter(period <= 9 & type == "wiki")
wiki_seq_day10 <- sequences %>% 
  filter(period <= 10 & type == "wiki")
wiki_seq_day11 <- sequences %>% 
  filter(period <= 11 & type == "wiki")
wiki_seq_day12 <- sequences %>% 
  filter(period <= 12 & type == "wiki")
wiki_seq_day13 <- sequences %>% 
  filter(period <= 13 & type == "wiki")
wiki_seq_day14 <- sequences %>% 
  filter(period <= 14 & type == "wiki")
```
