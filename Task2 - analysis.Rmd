...
# data_Ko <- fromJSON("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/Task2/Task2_SozPraes_Ko_content.txt")
# data_M <- fromJSON("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/Task2/Task2_SozPraes_M_content.txt")
# data_MG <- fromJSON("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/Task2/Task2_SozPraes_MG_content.txt")
# 
# 
# ### SEQUENCES ###
...
# 
# write.csv2(sequences, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_activities.csv")
# 
# ### WORK IMBALANCE ###
...
# 
# write.csv2(work_imbalances, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_work_imbalances.csv")
# 
...
#   addConditions()
# 
# write.csv2(wiki_wordcounts, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_wiki_wordcounts.csv")
# 
...
#   addConditions()
# 
# write.csv2(forum_wordcounts, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_forum_wordcounts.csv")
# 
...
# 
# 
# write.csv2(groups_and_users, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_groups_and_users.csv")
...
```{r}
# ### ONCE ###
# sequences <- read.csv2("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_activities.csv", stringsAsFactors = F) %>%
#   subset(select=-X) %>%
#   rowwise() %>%
...
#   arrange(timestamp, .by_group = T)
# 
# write.csv2(sequences2, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_activities.csv")
# 
...
#write.csv2(sequences, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_activities_2.csv")
...
```{r}
### READ DATA ###
task2_work_imbalance <- read.csv2("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_work_imbalances.csv", stringsAsFactors = F) %>% 
  subset(select=-X)
task2_wiki_wordcounts <- read.csv2("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_wiki_wordcounts.csv", stringsAsFactors = F) %>% 
  subset(select=-X)
task2_forum_wordcounts <- read.csv2("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_forum_wordcounts.csv", stringsAsFactors = F) %>% 
  subset(select=-X)
```

```{r}
wiki_wordcounts <- task2_wiki_wordcounts
names(wiki_wordcounts)[names(wiki_wordcounts) == 'user_wordcount'] <- 'wiki_wordcount'

forum_wordcounts <- task2_forum_wordcounts
names(forum_wordcounts)[names(forum_wordcounts) == 'user_wordcount'] <- 'forum_wordcount'

task2_wordcounts <- merge(wiki_wordcounts, forum_wordcounts, by = c("user_id", "group_id", "condition")) %>% 
  rowwise() %>% 
...
groups_and_users <- read.csv2("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_groups_and_users.csv", stringsAsFactors = F) %>% 
  subset(select = -X) %>%
  mutate(wordcount = 0)
...
#write.csv2(changing_gini, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_changing_gini.csv")
...
#write.csv2(changing_activity_count, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_changing_activity_count.csv")
...
work_imbalance_for_condition <- task2_work_imbalance %>%
  group_by(condition) %>% 
...
#write.csv2(changing_wiki_activity_count, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task2_changing_wiki_activity_count.csv")
