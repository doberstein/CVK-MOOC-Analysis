...
# write.csv2(changing_activity_count, "/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/analysis/task6_changing_activity_count.csv", row.names = F)
```

#wordcounts for each group after x days (for sebastian)
```{r}
# # for each group
