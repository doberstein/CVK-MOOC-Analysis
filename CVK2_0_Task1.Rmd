...
data_M_H <- fromJSON("/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/Task1/Task1_M_H_content.txt")
data_M_H_T <- fromJSON("/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/Task1/Task1_M_H_T_content.txt")
data_O_H <- fromJSON("/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/Task1/Task1_O_H_content.txt")
...
# combine all files to a single table and filter wrong messages
...
#write.csv2(sequences, "/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/analysis/task1_activities.csv", row.names = F)
...
# write.csv2(work_imbalances, "/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/analysis/task1_work_imbalances.csv", row.names = F)
...
# write.csv2(weighted_wiki_wordcounts, "/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/analysis/task1_weighted_wiki_wordcounts.csv", row.names = F)
...
# write.csv2(forum_shares, "/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/analysis/task1_forum_shares.csv")
...
# write.csv2(groups_and_users, "/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/analysis/task1_groups_and_users.csv")
```
...
#write.csv2(sequences2, "/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/analysis/task1_activities.csv")
...
task1_start_activity <- data.frame(as.list(c(group_id=1, content="start", object_id="start", object_name="start", object_type="start", timestamp=task1_start, user_id="start", verb_id="start", wordcount=0, condition="test", day="2019-10-21", period=1, type="start", class="start")))
...
#write.csv2(all_sequences_with_start, "/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/analysis/t1_activities_with_start.csv", row.names = F)
...
groups_and_users <- read.csv2("/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/analysis/task1_groups_and_users.csv", stringsAsFactors = F) %>% 
  subset(select = -X) %>%
  mutate(wordcount = 0)
...
#write.csv2(changing_gini, "/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/analysis/task1_changing_gini.csv", row.names = F)
...
#write.csv2(changing_activity_count, "/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/analysis/task1_changing_activity_count.csv", row.names = F)
```
...
# write.csv2(changing_word_count, "/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/analysis/task1_changing_word_count.csv", row.names = F)
```
...
overall_wordcounts_timeslice <- overall_average_wordcount_day1 %>% 
  addConditionsCVK2() %>% 
  group_by(condition) %>% 
  summarise(wordcount_day1 = sum(group_wordcount_day1))

#write.csv2(overall_wordcounts, "/home/doberstein/Dropbox/D/uni/IKARion/CVK 2_0/analysis/task1_group_wordcounts.csv", row.names = F)
