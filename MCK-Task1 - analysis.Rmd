...
```{r}
# ## ONCE ###
# sequences <- read.csv2("/home/doberstein/Dropbox/D/uni/IKARion/MCK MOOC - SoSe19/analysis/task1_activities.csv", stringsAsFactors = F) %>%
#   rowwise() %>%
...
#   arrange(timestamp, .by_group = T)
# 
# write.csv2(sequences2, "/home/doberstein/Dropbox/D/uni/IKARion/MCK MOOC - SoSe19/analysis/task1_activities.csv", row.names = F)
```
...
write.csv2(self_assessnemt_M, "/home/doberstein/Dropbox/D/uni/IKARion/MCK MOOC - SoSe19/analysis/task1_self_assessments.csv", row.names = F)
```
