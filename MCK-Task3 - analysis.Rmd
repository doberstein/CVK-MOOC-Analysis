...
data_S <- fromJSON("/home/doberstein/Dropbox/D/uni/IKARion/MCK MOOC - SoSe19/Task 3/Task3_EA3_S_with_content.txt")
data_M <- fromJSON("/home/doberstein/Dropbox/D/uni/IKARion/MCK MOOC - SoSe19/Task 3/Task3_EA3_M_with_content.txt")
...
write.csv2(sequences, "/home/doberstein/Dropbox/D/uni/IKARion/MCK MOOC - SoSe19/analysis/task3_activities.csv", row.names = F)
...
write.csv2(work_imbalances, "/home/doberstein/Dropbox/D/uni/IKARion/MCK MOOC - SoSe19/analysis/task3_work_imbalances.csv", row.names = F)
...
write.csv2(weighted_wiki_wordcounts, "/home/doberstein/Dropbox/D/uni/IKARion/MCK MOOC - SoSe19/analysis/task3_weighted_wiki_wordcounts.csv", row.names = F)
...
write.csv2(forum_shares, "/home/doberstein/Dropbox/D/uni/IKARion/MCK MOOC - SoSe19/analysis/task3_forum_shares.csv")
...
write.csv2(groups_and_users, "/home/doberstein/Dropbox/D/uni/IKARion/MCK MOOC - SoSe19/analysis/task3_groups_and_users.csv")
```

### DATA PREPROCESSING: WIKI WORDCOUNT CALCULATION
```{r}
## ONCE ###
sequences <- read.csv2("/home/doberstein/Dropbox/D/uni/IKARion/MCK MOOC - SoSe19/analysis/task3_activities.csv", stringsAsFactors = F) %>%
  rowwise() %>%
...
write.csv2(sequences2, "/home/doberstein/Dropbox/D/uni/IKARion/MCK MOOC - SoSe19/analysis/task3_activities.csv", row.names = F)
```
...
write.csv2(self_assessnemt_M, "/home/doberstein/Dropbox/D/uni/IKARion/MCK MOOC - SoSe19/analysis/task3_self_assessments.csv", row.names = F)
```
