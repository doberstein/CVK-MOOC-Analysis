...
all_changing_activity_count <- rbind(task1_changing_activity_count, task2_changing_activity_count)

all_changing_gini <- rbind(task1_changing_gini, task2_changing_gini)
