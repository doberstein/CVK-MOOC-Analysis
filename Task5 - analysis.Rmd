...
data_NA <- fromJSON("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/Task 5/Task5_Informationsaustausch_NA_with_content.txt")
data_WA <- fromJSON("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/Task 5/Task5_Informationsaustausch_WA_with_content.txt")
...
write.csv2(sequences, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task5_activities.csv")
...
write.csv2(work_imbalances, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task5_work_imbalances.csv")
...
write.csv2(groups_and_users, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task5_groups_and_users.csv")
```

### DATA PREPROCESSING: WIKI WORDCOUNT CALCULATION
```{r}
## ONCE ###
sequences <- read.csv2("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task5_activities.csv", stringsAsFactors = F) %>%
  subset(select=-X) %>%
  rowwise() %>%
...
write.csv2(sequences2, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task5_activities.csv")
...
write.csv2(sequences, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task5_activities_2.csv")
...
groups_and_users <- read.csv2("/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task5_groups_and_users.csv", stringsAsFactors = F) %>% 
  subset(select = -X) %>%
  mutate(wordcount = 0)
...
write.csv2(changing_gini, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task5_changing_gini.csv")
...
write.csv2(changing_activity_count, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/task5_changing_activity_count.csv")
