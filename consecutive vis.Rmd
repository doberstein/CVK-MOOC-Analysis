...
```{r}
# write.csv2(overall_activity_distribution_for_condition, "/home/doberstein/Dropbox/D/uni/IKARion/CVK MOOC - WS18_19/analysis/wiki_activitiy_distribution_for_condition.csv", row.names = F)
